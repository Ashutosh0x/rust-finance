...
pub fn bval_3step_pricer(inputs: &BondPricingInputs) -> BvalOutput {
    ...
    let bval_score = (inputs.step1_obs_quality * 0.5 + inputs.step2_corr_confidence * 0.3 + 0.2) * 10.0;
...
pub fn bond_duration_metrics(cashflows: &[(f64, f64)], ytm: f64, freq: f64) -> (f64, f64, f64) {
    ...
    if price == 0.0 { return (0.0, 0.0, 0.0); }
    mac_dur /= price;
...
pub fn bond_price_change_approximation(mod_dur: f64, conv: f64, initial_price: f64, yield_change: f64) -> f64 {
